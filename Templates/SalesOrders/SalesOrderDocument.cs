...
public class SalesOrderDocument : IDocument
{
    ...
    public SalesOrderDocument(SalesOrderDetailDto model, BusinessInfoDto businessInfo)
    {
        Model = model;
    ...
    void ComposeHeader(IContainer container)
    {
        ...
        container.Row(row =>
        {
            ...
            {
                column.Item().Text($"ALBARAN #{Model.Id}").Style(titleStyle);
    ...
    void ComposeContent(IContainer container)
    {
        ...
        container.PaddingVertical(25).Column(column =>
        {
            ...
            var salesOrderProducts = Model.SalesOrderProducts.Select(x => new CalculableItem()
            {
                Price = x.Price,
                Quantity = x.Quantity,
                Discount = x.Discount
