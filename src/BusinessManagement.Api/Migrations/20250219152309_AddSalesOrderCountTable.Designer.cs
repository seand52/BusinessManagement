...
namespace BusinessManagement.Migrations
{
    ...
    [Migration("20250219152309_AddSalesOrderCountTable")]
    partial class AddSalesOrderCountTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessManagementApi.Models.InvoiceCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BusinessManagementApi.Models.SalesOrderCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BusinessManagementApi.Models.InvoiceCount", b =>
                {
                    b.HasOne("BusinessManagementApi.Models.User", "User")
                        .WithOne("InvoiceCount")
                        .HasForeignKey("BusinessManagementApi.Models.InvoiceCount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
